...
object AppModule {
    ...
    fun provideNewsUseCases(
        ...
        upsertArticleUseCase = UpsertArticleUseCase(newsDao = newsDao),
        deleteArticleUseCase = DeleteArticleUseCase(newsDao = newsDao),
        selectArticlesUseCase = SelectArticlesUseCase(newsDao = newsDao),
    )
